    ...
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 margin'>
            <div className='flex flex-col justify-center items-start'>
                <h1 className='text-8xl text-blue-600 font-bold'>ProjectPro</h1>
                <h3 className='text-4xl text-blue-400 font-bold pb-5 pt-8'>Visualize your workflow</h3>

                <div className='border-b-8 border-blue-600 w-2/6' />

                <div className='text-sky-600 mt-6'>
                    ...
                    <div className='flex justify-start items-center'>
                        ...
                        <a
                            ...
                            href='https://en.wikipedia.org/wiki/Project_management_software'
                            target='_blank'
                            rel='noreferrer'
                        >
                            More Info 
